Rollbar.configure do |config|
  ...
  config.access_token = ENV["RHINO_PUBLIC_ROLLBAR_ACCESS_TOKEN"]
  ...
  # environment variable like this: `RHINO_PUBLIC_ROLLBAR_ENV=staging`. This is a recommended
  # setup for Heroku. See:
  # https://devcenter.heroku.com/articles/deploying-to-a-custom-rails-environment
  config.environment = ENV["RHINO_PUBLIC_ROLLBAR_ENV"] || Rails.env
end
